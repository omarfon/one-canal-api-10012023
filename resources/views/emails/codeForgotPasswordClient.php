                  ...
                  <div style="width: 100% !important;">
                    ...
                    <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;" align="left">
                              ...
                              <div style="color: #34495e; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 26px; line-height: 36.4px;"><strong><span style="line-height: 36.4px; font-size: 26px;">Usted acaba de solicitar la recuperación de contraseña de su cuenta asociada a la aplicación One Canal.</span></strong></span></p>
                              </div>
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:'Montserrat',sans-serif;" align="left">
                              ...
                              <div style="color: #686d6d; line-height: 210%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 210%;"><b><?php echo $details['names'] . " " . $details['surnames'] ?></b>, mediante este correo se le notifica que se le ha generado un código válido por 15 minutos para recuperación de contraseña de su cuenta.</p>
                                <p>&nbsp;</p>
                                <p>Para generar una nueva contraseña de acceso a la plataforma, por favor ingrese el siguiente código en la pantalla correspondiente: </p>
                              </div>
                      ...
                      <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;font-family:'Montserrat',sans-serif;" align="left">

                            <div style="color: #34495e; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 26px; line-height: 36.4px;"><strong><span style="line-height: 36.4px; font-size: 26px;"><?php echo $details['token'] ?></span></strong></span></p>
                              </div>
                              <p>&nbsp;</p>
                            </td>
                          </tr>
