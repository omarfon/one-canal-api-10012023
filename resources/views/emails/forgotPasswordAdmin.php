                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;" align="left">
                              ...
                              <div style="color: #34495e; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 26px; line-height: 36.4px;"><strong><span style="line-height: 36.4px; font-size: 26px;">Solicitud de <br>One Canal Back Office</span></strong></span></p>
                              </div>
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 33px;font-family:'Montserrat',sans-serif;" align="left">
                              ...
                              <div style="color: #686d6d; line-height: 210%; text-align: center; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 210%;">mediante este correo se le notifica que se ha solicitado la recuperación de contraseña de su usuario en One Canal Back Office.</p>
                                <p>&nbsp;</p>
                                <p>Este es el código para ingresar en donde el Back Office le indique para recuperar su contraseña: </p>
                                <p>&nbsp;</p>
                                <p><span style="font-size: 30px"><?php echo $details['token'] ?></span></p>
                              </div>
